...
export type GithubSearchRepos = Endpoints['GET /search/repositories']['response']['data'];
export type GithubSearchUsers = Endpoints['GET /search/users']['response']['data'];
export type GithubLanguages = Endpoints['GET /repos/{owner}/{repo}/languages']['response']['data'];
export type GithubReadme = Endpoints['GET /repos/{owner}/{repo}/readme']['response']['data'];
